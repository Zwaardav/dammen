...
public class Controller extends Observable implements OnTouchListener,View.OnGenericMotionListener {
	...
	public boolean onGenericMotion(View view, MotionEvent motionEvent) {
		...
		int x = (int) ((motionEvent.getX() - margin_horizontal ) / cell_size);
		int y = (int) ((motionEvent.getY() - margin_vertical ) / cell_size);
		Log.d("Controller",cell_size + " " + margin_horizontal + " " + margin_vertical);
		//Log.d("Controller","x: " + x + " y: " + y);
		Log.d("Controller","Piemel");
		game.selectDamsteen(x,y);
		return true;
	}
}
